...
TREE(3) Vocations funds its work through small, transparent, scope-specific
campaigns. What each dollar builds is stated before it's raised, and funded
deliverables are released publicly.
...
that can be verified, records that cannot be silently altered, and governance
held by the people in the relationship. That layer is what we build — and
give away.

[PLACEHOLDER — Veri + Spark: optionally, two or three sentences for the
would-be donor who has read this far. Warm, plain, no pitch-speak.]
